...
for x,fileName in enumerate(images_path):
    ...
    combine_model.part_weight['eye1'] = 1
    combine_model.part_weight['eye2'] = 1
    combine_model.part_weight['nose'] = 1
    combine_model.part_weight['mouth'] = 1
    combine_model.part_weight[''] = 1
