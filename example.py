...
for x,fileName in enumerate(images_path):
    ...
    combine_model.part_weight['eye1'] = 0
    combine_model.part_weight['eye2'] = 0
    combine_model.part_weight['nose'] = 0
    combine_model.part_weight['mouth'] = 0
    combine_model.part_weight[''] = 0
